...
const CalculatorInput = ({
  ...
  return (
    <div className="flex flex-col gap-3">
      <label className="text-gray-100" htmlFor="totalNoOfViewers">
...
const CalculatorMain = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-105px)] select-none">
      <div className="w-full flex justify-center items-center flex-col -translate-y-8">
        <div>
          <h2 className="text-3xl mb-8">Live's Calculator</h2>
        </div>
        <div className="flex text-xl gap-4 mb-8">
          <span
            onClick={() => setStreamer(true)}
            className={clsx(
              "cursor-pointer transition-all duration-300",
              "px-[1px] py-[1px] rounded-md flex",
              isStreamer &&
                "bg-gradient-to-r cursor-pointer from-gray-600 to-blue-100"
            )}
          >
            <span className="w-full bg-black rounded-md p-1 px-3">
              I am a streamer
            </span>
          </span>
          <span
          ...
          >
            <span className="w-full relative bg-black rounded-md p-1 px-3">
              I am an advertiser
            </span>
          </span>
        </div>
        <div className="w-[90%] min-h-[360px] lg:w-[65%] transition-all duration-300 border border-dashed rounded-md border-blue-300 flex items-stretch justify-center">
          <div className="w-1/2 px-6 pt-5 pb-2 relative flex flex-col">
          ...
          <div className="flex w-1/2 flex-col justify-start relative items-center border-l border-blue-600 p-4 border-dashed">
            <span className="text-2xl uppercase text-white rounded-md bg-gray-900 py-2 w-full text-center font-bold">
              {
