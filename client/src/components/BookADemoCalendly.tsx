...
import {FcCalendar, FcCellPhone, FcPhone, FcPlanner, FcVideoCall} from "react-icons/fc";

const BookADemoCalendly = () => {
    ...
    return (
        <a
            ...
            target={"_blank"}
            rel="noreferrer"
            className="fixed group  bottom-4 md:bottom-6 md:left-6 group left-4 flex z-50 items-center justify-center gap-2"
        >
        ...
        {/* <FaCalendarAlt size={21}></FaCalendarAlt> */}
                <FcVideoCall size={35}></FcVideoCall>
      </span>
        </a>
    );
};

export default BookADemoCalendly;
